        ...
        <flux:sidebar sticky stashable class="bg-zinc-50 dark:bg-zinc-900 border-r rtl:border-r-0 rtl:border-l border-zinc-200 dark:border-zinc-700">
            ...
            <flux:navlist>
                <flux:navlist.group :heading="__('Organization')" variant="outline">
                    <flux:navlist.item icon="cog-6-tooth" :href="route('organizations.settings.general', auth()->user()->currentOrganization)" wire:navigate>{{ __('Settings') }}</flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
